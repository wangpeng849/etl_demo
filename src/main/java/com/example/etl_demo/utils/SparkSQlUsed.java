...
//        SparkSession sparkSession = SparkSession.builder().appName("Spark Java MySQL").master("local").getOrCreate();
        ...
        //第四步：将数据写入到表中
//        writeMySQL(dataFrame);

        sparkContext.stop();
    }

    private static void writeMySQL(Dataset<Row> dataFrame) {
        //jdbc.url=jdbc:mysql://localhost:3306/database
        String url = "jdbc:mysql://127.0.0.1/homework?autoReconnect=true&useUnicode=true&characterEncoding=utf8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&allowMultiQueries=true&serverTimezone=UTC&serverTimezone=Asia/Shanghai";
        //查找的表名
        ...
        dataFrame.write().mode("append").jdbc(url,table,connectionProperties);
    }
